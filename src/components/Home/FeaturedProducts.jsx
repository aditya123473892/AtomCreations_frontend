...
<div className="flex flex-col md:flex-row w-full">
  {/* Show imprints image */}
        <div className="relative w-full md:w-6/12 h-full md:h-[80vh] flex items-end justify-end mr-1">
    <div
  ...
  {/* Show French Terry image */}
        <div className="relative w-full md:w-6/12 h-full md:h-[80vh] flex items-end justify-end ml-1">
    <div
