    ...
    <div className="min-h-screen bg-custom-bg-color  text-black py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.h1
          ...
          className="text-4xl sans-bold font-extrabold text-left mb-8"
        >
          About Us
        </motion.h1>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          >
            <h2 className="text-2xl sans-bold font-semibold mb-4">Our Story</h2>
            ...
            <p className="text-black sans-regular">
          ...
          <motion.div
            ...
            className="bg-custom-dark rounded-lg p-8 shadow-2xl"
          >
            <h2 className="text-2xl text-black sans-bold font-semibold mb-4">Our Values</h2>
            <ul className="space-y-4">
              <li className="flex items-start">
                <FaQuoteLeft className="text-black-600 mr-2 mt-1" />
        ...
        >
          ...
          <p className="text-gray-400 mx-auto max-w-2xl">
            <FaQuoteLeft className="inline-block text-black-600 mr-2" />
            ...
            <FaQuoteRight className="inline-block text-black-600 ml-2" />
          </p>
        </motion.div>
      </div>
    </div>
