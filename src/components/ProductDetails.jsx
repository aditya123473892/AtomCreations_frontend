...
const ProductDetails = () => {
    ...
    const fetchProduct = async () => {
      ...
      try {
        const getMyProduct = await axios.get(
          `https://atom-creations-backend-rc06amtad-adityas-projects-a14514f1.vercel.app//api/products/${id}`
        );
  ...
  const handleFavoriteClick = async () => {
    ...
    if (!logindata) {
      ...
      try {
        await axios.post(
          "https://atom-creations-backend-rc06amtad-adityas-projects-a14514f1.vercel.app//api/appuser/addToWishList",
          {
            productId: id,
          },
          {
