  ...
  return (
    <div className="min-h-screen bg-custom-bg-color text-black py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-2xl font-semibold sans-bold mb-4">Shipping Partner</h2>
          <p className="text-black sans-regular mb-6">
          ...
          <h3 className="text-xl font-semibold sans-bold mb-2">Shipping Timeframe</h3>
          <p className="text-black sans-regular mb-6">
          ...
          <h3 className="text-xl font-semibold sans-bold mb-2">Shipping Rates</h3>
          <p className="text-black sans-regular mb-6">
