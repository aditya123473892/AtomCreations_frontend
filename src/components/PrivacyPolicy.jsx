    ...
    <div className="min-h-screen bg-custom-bg-color text-black py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.h1
          ...
          className="text-4xl font-extrabold sans-bold text-left mb-8"
        >
          Privacy Policy
        </motion.h1>
        <motion.div
        ...
        >
          <h2 className="text-2xl font-semibold sans-bold mb-4">
          ...
          <ul className="list-disc list-inside text-black sans-regular mb-4">
