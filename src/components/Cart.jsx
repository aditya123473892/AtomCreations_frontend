...
const Cart = () => {
  ...
  const removeFromCart = async (id, size) => {
    ...
    const res = await axios.put(
      "https://atom-creations-backend-git-main-adityas-projects-a14514f1.vercel.app//api/appuser/removefromcart",
      {
        productId: id,
        size: size,
      },
  ...
  const clearCart = async () => {
    ...
    const res = await fetch(
      "https://atom-creations-backend-git-main-adityas-projects-a14514f1.vercel.app//api/appuser/emptycart",
      {
        method: "POST",
        headers: {
  ...
  const incrementQuantity = async (id, size) => {
    const token = localStorage.getItem("token");
    const res = await axios.put(
      "https://atom-creations-backend-git-main-adityas-projects-a14514f1.vercel.app//api/appuser/incquantity",
      {
        productId: id,
        size: size,
      },
  ...
  const decrementQuantity = async (id, size) => {
    const token = localStorage.getItem("token");
    const res = await axios.put(
      "https://atom-creations-backend-git-main-adityas-projects-a14514f1.vercel.app//api/appuser/decquantity",
      {
        productId: id,
        size: size,
      },
