  ...
  const handleAddAddress = async () => {
    ...
    try {
      const res = await axios.post(
        "https://atom-creations-backend-rc06amtad-adityas-projects-a14514f1.vercel.app//api/appuser/addAdress",
        {
          address,
          city,
          state,
  ...
  const handleDeleteAddress = async (id) => {
    ...
    try {
      const res = await axios.put(
        "https://atom-creations-backend-rc06amtad-adityas-projects-a14514f1.vercel.app//api/appuser/deleteAddress",
        {
          addressId: id,
        },
        {
  ...
  useEffect(() => {
    ...
    const getAddress = async () => {
      const res = await axios.get(
        "https://atom-creations-backend-rc06amtad-adityas-projects-a14514f1.vercel.app//api/appuser/getaddress",
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
