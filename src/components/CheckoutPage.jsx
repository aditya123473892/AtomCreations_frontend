      ...
      if (itemId) {
        try {
          const res = await axios.post(
            "https://atom-creations-backend-rc06amtad-adityas-projects-a14514f1.vercel.app/api/appuser/placeorder",
            {
              address,
              email,
              name,
      ...
      if (itemId) {
        try {
          const res = await axios.get(
            `https://atom-creations-backend-rc06amtad-adityas-projects-a14514f1.vercel.app/api/products/${itemId}`
          );
          setItem(res.data);
