    ...
    if (email === "") {
      ...
      try {
        const response = await axios.post(
          "https://atom-creations-backend-git-main-adityas-projects-a14514f1.vercel.app/api/user/forgot-password-token",
          {
            email,
          }
        );
    ...
    if (email === "" || password === "") {
      ...
      try {
        const res = await axios.post(
          "https://atom-creations-backend-git-main-adityas-projects-a14514f1.vercel.app/api/user/login",
          {
            email,
            password,
          }
