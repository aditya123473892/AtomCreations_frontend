    ...
    <div className="min-h-screen bg-white text-black py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          >
            <h2 className="text-2xl text-black font-semibold mb-4">Stay Connected</h2>
              ...
              <div className="flex flex-col md:flex-row items-center">
                <div className="flex items-center w-full mb-4 md:mb-0 md:w-auto">
                  ...
                  <input
                    ...
                    className="bg-gray-200 rounded-lg py-2 px-4 text-white focus:outline-none focus:ring-2 focus:ring-indigo-600 flex-grow"
                    required
                  />
                </div>
                <button
          ...
          <motion.div
            ...
            className="bg-gray-200 rounded-lg p-8 shadow-2xl"
          >
            <h2 className="text-2xl text-black font-semibold mb-4">Follow Us</h2>
            <p className="text-gray-900 mb-4">
        ...
        >
          ...
          <p className="text-gray-900 mx-auto max-w-2xl mb-6">
