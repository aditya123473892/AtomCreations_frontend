...
const ConfirmationPage = ({ selectedItem }) => {
  ...
  const handleApplyCoupon = async () => {
    ...
    try {
      ...
      const res = await axios.put(
        `https://atom-creations-backend-rc06amtad-adityas-projects-a14514f1.vercel.app//api/appuser/applyCoupon/${orderId}`,
        {
          couponCode,
        },
        {
  ...
  const handleConfirmOrder = async () => {
    ...
    try {
      ...
      if (orderId) {
        const res = await axios.put(
          "https://atom-creations-backend-rc06amtad-adityas-projects-a14514f1.vercel.app//api/appuser/confirmOrder",
          {
            orderId: orderId,
          },
          {
  ...
  const handlePayNow = async (amount) => {
    ...
    try {
      ...
      const {
        ...
        "https://atom-creations-backend-rc06amtad-adityas-projects-a14514f1.vercel.app//api/payment/getkey"
      );

      const {
        data: { order },
      } = await axios.post(
        "https://atom-creations-backend-rc06amtad-adityas-projects-a14514f1.vercel.app//api/payment/checkout",
        {
      ...
      const options = {
        ...
        image: icon,
        order_id: order.id,
        callback_url: `https://atom-creations-backend-rc06amtad-adityas-projects-a14514f1.vercel.app//api/payment/paymentverification/${orderId}`,
        prefill: {
    ...
    const fetchOrderDetails = async () => {
      ...
      try {
        ...
        const res = await axios.get(
          `https://atom-creations-backend-rc06amtad-adityas-projects-a14514f1.vercel.app//api/appuser/getorder/${orderId}`,
