  ...
  return (
    <div className="min-h-screen bg-white text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-2xl text-black font-semibold mb-4">No Refunds</h2>
          ...
          <h3 className="text-xl text-black font-semibold mb-2">Reasons for No Refunds</h3>
          ...
          <h3 className="text-xl text-black font-semibold mb-2">Cancellations</h3>
          <p className="text-gray-900 mb-6">
          ...
          <h3 className="text-xl text-black font-semibold mb-2">Exceptional Cases</h3>
